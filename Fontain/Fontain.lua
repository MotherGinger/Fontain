...
function mod:OnEnable()
	...
	for k, v in pairs(_G) do
		...
		if type(v) == "table" then
			...
			local _, objType = pcall(v.GetObjectType, v)
			if meta and type(meta) == "table" and meta.__index and type(meta.__index) == "table" and meta.__index.GetFont and objType == "Font" then
				tinsert(fontList, v)
			end
		end
	end
...
do
	...
	local function setFont(f, key)
		...
		if not key == "FontainExample" then
